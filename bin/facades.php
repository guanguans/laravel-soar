...
/**
 * @fixme 适配 Laravel 10 以下版本
 */
(function():void{
    \Illuminate\Support\Stringable::macro('toString', fn () => $this->value);
    \Illuminate\Support\Str::macro('squish', static fn ($value): string => preg_replace(
        '~(\s|\x{3164}|\x{1160})+~u',
        ' ',
